      ...
      child: Column(
        children: [
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('Purchase / Sale Entry',
                          style: Theme.of(context).textTheme.headlineMedium),
                      const SizedBox(height: 4),
                      Text('Select a truck to view or add customer details',
          ...
          Expanded(
            child: lots.isEmpty
                ? Center(
                    child: Text('No trucks added yet. Click "Add Truck" to start.',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _TruckCard(
                          lot: lot,
                          isDark: isDark,
                          onTap: () => context.push('/data-entry/purc-spat/${lot.id}'));
                    },
                  ),
          ),
        ],
...
class _TruckCard extends StatelessWidget {
  const _TruckCard({required this.lot, required this.isDark, required this.onTap});
            ...
            children: [
              ...
              Expanded(
                  child: Column(
                    ...
                    const SizedBox(height: 4),
                    Text('Party: ${lot.partyName}',
                        style: Theme.of(context).textTheme.bodySmall)
                  ])),
              Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Text('${Money.formatQuantity(lot.bags)} bags',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                            fontWeight: FontWeight.w600)),
                    if (lot.totalCarets > Money.zero) ...[
                      const SizedBox(height: 2),
                      Text('${Money.formatQuantity(lot.totalCarets)} carets',
                          style: Theme.of(context).textTheme.bodySmall)
                    ],
                    const SizedBox(height: 2),
                    Text('${lot.sales.length} customers',
